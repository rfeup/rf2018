...
begin
  ...
  DebugVOdo.Text:= FloatToStr(v_odo);
  DebugVnOdo.Text:= FloatToStr(vn_odo);
  DebugWOdo.Text:= FloatToStr(w_odo);
...
begin
  ...
  WheelDist := StrToFloatDef(EditWheelDistance.Text, 0.12350);
  WheelRadius := StrToFloatDef(EditWheelRadius.Text, 0.029785);
